...
Conveyor families keep all five connection states and four animation frames, but the old painted chevrons are replaced by the approved concept's bevelled alloy chassis, visible roller banks, and wide interlocking plate deck. The actual approved raster design is separated into static rails and a moving center deck; the deck advances by one quarter of its plate pitch per frame for a seamless loop. Standard, titanium, armored, plastanium, and surge variants retain their approved orange, cyan, reinforced-steel, violet, and heat-orange material identities. Duct and conduit covers are reconstructed from their lower routing paths, leaving open channels for engine-drawn items and fluids. Stack-conveyor move/load/unload states, bridge spans, directional caps, item-color masks, and additive power-glow masks remain independent.
