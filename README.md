...
The 0.6.0 transport pass replaces painted arrows with physical motion systems. Standard conveyors use wide transverse gunmetal slats, titanium conveyors use blue linked plates, plastanium conveyors use lime stacking hardware, and armored conveyors use violet side armor around a broad heavy tread. Each of the five connection topologies shares one exact alpha footprint across its four moving frames. Junctions, bridges, gates, routers, unloaders, and mass drivers use centered lanes and layer-separated machinery instead of full-sheet overlays.

The liquid set covers all 19 Serpulo and Erekir pumps, conduits, junctions, bridges, routers, containers, and tanks with 68 exact-name layers. Conduits use continuous recessed fluid channels and narrow structural covers instead of enlarged direction glyphs. Mechanical, rotary, impulse, and reinforced pumps are distinguished by their impeller, multi-vane rotor, pressure core, and armored piston assembly. Liquid masks remain independent and tint-compatible with the original renderer.
