...
The 0.6.1 transport correction keeps every build 159.7 silhouette, connection topology, installation orientation, frame-specific animation footprint, and independent upper/lower/moving layer. Standard conveyors use wide transverse gunmetal slats, titanium conveyors use blue linked plates, plastanium conveyors use lime stacking hardware, and armored conveyors use violet side armor around a broad heavy tread. Junctions, bridges, gates, routers, unloaders, mass drivers, ducts, and cargo structures are now restyled directly from their corresponding vanilla layers; concept sheets are reference material only and are never inserted as complete gameplay sprites.

The liquid set covers all 19 Serpulo and Erekir pumps, conduits, junctions, bridges, routers, containers, and tanks with 68 exact-name layers. Every connection cap, directional frame, bridge arrow, pump layer, tank cover, and liquid mask retains its vanilla geometry and draw contract. Mechanical, rotary, impulse, and reinforced pumps are distinguished through gunmetal shading, cyan or orange machine channels, and stronger top-down reflections; the seven renderer-tinted liquid masks remain byte-for-byte equivalent to their 4x vanilla sources.
