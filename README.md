...
The 0.6.2 transport correction is based on the build 159.7 drawing code as well as the source images. It keeps every silhouette, connection topology, installation orientation, frame-specific animation mechanism, independent upper/lower/moving layer, runtime item-color mask, and additive power-glow mask. The previous uniform tread overlay was removed because it hid the conveyor connection and movement patterns despite matching their alpha. Junctions, bridges, gates, routers, unloaders, mass drivers, ducts, conduits, pumps, tanks, and cargo structures are now restyled directly from the luminance structure of their corresponding vanilla layers.
